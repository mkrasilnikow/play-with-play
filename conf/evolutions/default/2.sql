...
insert into products (id,brand,model,startYear,mileage,price) values (DEFAULT, 'Dodje', 'Viper', 2000, 100, 40000);
insert into products (id,brand,model,startYear,mileage,price) values (DEFAULT, 'Dodje', 'Viper', 2001, 0, 100000);
insert into products (id,brand,model,startYear,mileage,price) values (DEFAULT, 'Honda', 'Civic', 1999, 130, 8000);
insert into products (id,brand,model,startYear,mileage,price) values (DEFAULT, 'Toyota', 'Rav4', 2006, 4000, 32000);
